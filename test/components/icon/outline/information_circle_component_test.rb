...
class Icon::Outline::InformationCircleComponentTest < ViewComponent::TestCase
  test "that component renders outline icon for information circle" do
    render_inline Icon::Outline::InformationCircleComponent.new(stroke_width: 2.5, classes: "w-5 h-5")
